...
mixin _$AuthState {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, loginStatus, signUpStatus, error);

  @override
  String toString() {
    return 'AuthState(loginStatus: $loginStatus, signUpStatus: $signUpStatus, error: $error)';
  }
}
...
abstract mixin class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Statuses loginStatus, Statuses signUpStatus, Failure? error});
}
...
extension AuthStatePatterns on AuthState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(
            Statuses loginStatus, Statuses signUpStatus, Failure? error)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AuthState() when $default != null:
        return $default(_that.loginStatus, _that.signUpStatus, _that.error);
      case _:
        return orElse();
    }
  }
...
class _AuthState extends AuthState {
  const _AuthState(
      ...
      this.signUpStatus = Statuses.initial,
      this.error})
      : super._();
